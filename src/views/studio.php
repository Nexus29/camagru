...
// Assuming an offset of 0 and a maximum of 10 recent thumbnails
$userSnapshots = [];
if (method_exists($snapshotModel, 'getPaginated')) {
    // We filter or pull snapshots. If your model doesn't have a personal filter yet,
    // we fetch recent snapshots or you can add a user-specific lookup query later.
